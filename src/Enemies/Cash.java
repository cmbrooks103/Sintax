...
public class Cash extends Enemy {
    private float movementSpeed; // Increase this value for faster fireball
    private int existenceFrames;

    public Cash(Point location, float movementSpeed, int existenceFrames) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("Resources/cash.png"), 7, 7), "DEFAULT");
