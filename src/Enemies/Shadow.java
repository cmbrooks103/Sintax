...
public class Shadow extends Enemy {
    ...
    public Shadow(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("shadow.png"), 14, 17), "WALK_RIGHT");
