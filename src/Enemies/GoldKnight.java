...
public class GoldKnight extends Enemy {
    ...
    public GoldKnight(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("goldknight.png"), 14, 17), "WALK_RIGHT");
