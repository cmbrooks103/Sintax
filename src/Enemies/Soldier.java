...
public class Soldier extends Enemy {
    ...
    public Soldier(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("soldier.png"), 14, 17), "WALK_RIGHT");
