...
public class Rabbit extends Enemy {
    ...
    public Rabbit(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("rabbit.png"), 14, 17), "WALK_RIGHT");
