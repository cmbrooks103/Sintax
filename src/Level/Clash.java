...
public class Clash extends MapEntity {
    private int lifespan; // Number of frames the explosion will exist

    public Clash(Point location, int lifespan) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("clash.png"), 16, 16), "DEFAULT");
