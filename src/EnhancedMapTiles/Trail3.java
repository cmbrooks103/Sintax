...
public class Trail3 extends EnhancedMapTile {
    ...
    public Trail3(Point location) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("Resources/sparks.png"), 16, 16), TileType.PASSABLE);
